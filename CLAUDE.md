...
**start with the "clone modern-agent verbatim" banner at the top**, which
governs the current look.

The renderer **clones the modern-agent web app verbatim**
(`~/Projects/modern-agent/packages/web/src`) in looks and design, with a
...
diverges from **modern-agent** — do **not** re-flag emdash mismatches.
